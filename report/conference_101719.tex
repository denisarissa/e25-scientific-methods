...
\subsection{\centering Research Topic}
...
\subsection{\centering Problem Area and Research Questions}
...
\subsection{\centering Relevant Reviews}
...
\subsection{\centering Search and Screening}
...
For the preliminary draft of the study, the initial search strategy was broadly defined, and this resulted in an uncertain number of potentially relevant papers which also required screening. The screening was defined to be done in multiple steps as proposed by Petersen et al. \cite{petersen2008}. Firstly it was done based on the title, followed by the abstract and finished with full text screening. This experience and the reflections developed from it are useful for more extensive pilot searching to test and refine search strings, which can improve efficiency.
...
\subsection{\centering Study Selection Process}
...
\subsection{\centering Data Extraction, Synthesis and Categorisation Framework}
...
\subsection{\centering Validity Threats}
...
\subsection{\centering Multi-drone Application Domain}
...
\subsection{\centering Communication Patterns}
...
\subsection{\centering Data Types and Information Exchange}
...
\subsection{\centering Agent Types and Interaction Patterns}
...
\subsection{\centering Architectural Layer Considerations}
...
\subsection{\centering Emerging Preliminary Patterns}
...
\subsection{\centering Assessment of Screening Process}
